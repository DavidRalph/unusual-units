...
const unitsLength = [
  ...
  { name: "Giraffes (height)", si: 5.5, penalty: 0 },
  ...
  { name: "Football Fields", si: 105, penalty: 0 },
  ...
  { name: "New York City Blocks", si: 274, penalty: 0 },
  { name: "Eiffel Towers", si: 324, penalty: 0 },
  { name: "Empire State Buildings", si: 443, penalty: 0 },
  { name: "Niagara Falls (height)", si: 99, penalty: 0 },
